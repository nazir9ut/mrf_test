...
int main()
{
    ...
    InitDataCost("/home/naz/Desktop/lbp/tsukuba-imL.png", "/home/naz/Desktop/lbp/tsukuba-imR.png", mrf);
    ...
    cv::imwrite("/home/naz/Desktop/lbp/output.png", output);
...
/**
 * Pad 16 pixels from all sides. Add DATA point
 */
void InitDataCost(const std::string &left_file, const std::string &right_file, MRF2D &mrf)
{
...
//    cv::waitKey(0);
    ...
    cout << "mrf.height = " << mrf.height << endl;
    cout << "mrf.width = " << mrf.width << endl;
...
//    cv::Mat tmp = cv::Mat::zeros(mrf.height, mrf.width, CV_8U);
//    cv::namedWindow("win", CV_WINDOW_AUTOSIZE);
...
//            for(int x = LABELS; x < mrf.width - LABELS; x++) {
//
//                tmp.at<uchar>(y,x) = mrf.grid[y * mrf.width + x].msg[DATA][i];
//            }
//
//        }
//
...
//    cv::imshow("1", tmps.at(1));
//    cv::imshow("2", tmps.at(2));
//    cv::imshow("3", tmps.at(3));
//    cv::imshow("4", tmps.at(4));
//    cv::waitKey(0);

//    cout << (tmps.at(4) == tmps.at(1)) << endl;
//    cout << tmps.at(15) << endl;
